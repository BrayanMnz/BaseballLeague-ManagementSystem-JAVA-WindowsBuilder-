...
public class main {
	...
	public static void main(String[] args) {
		...
		jugadorPosicion bate1 = new jugadorPosicion("Yehudy","24", 2,3,"Yankees",false,10,12,3,10,3,5,6,"2",2);
		jugadorPosicion bate2 = new jugadorPosicion("Brayan","25", 5,6,"Redsox",false,10,14,3,8,3,6,10,"5",2);
